...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("VsDavePE", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("VsDavePE", null, 1280, 720);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["build"] = "3";
		app.meta["company"] = "Vs. Dave and Bambi Definitive Edition Team";
		app.meta["file"] = "VsDavePE";
		app.meta["name"] = "Friday Night Funkin': Vs Dave And Bambi Definitive Edition & Bambi's Purgatory";
		app.meta["packageName"] = "com.vdabdet.vdabde";
		...
		var attributes:lime.ui.WindowAttributes = {
			...
			parameters: {},
			resizable: true,
			title: "Friday Night Funkin': Vs Dave And Bambi Definitive Edition & Bambi's Purgatory",
			width: 1280,
			x: null,
			y: null,
		};
